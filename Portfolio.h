...
class Portfolio
{
    ...
    public:
        ...
        void Buy_Share(std::string Ticker, int Current_Year, int Units); // Buys stock
        void Sell_Share(std::string Ticker, int Current_Year, int Units); // Sell Stock
        bool Reached_Share_Max(); // Returns true if stock can be added as maximum amount of shares hasnt been reached
